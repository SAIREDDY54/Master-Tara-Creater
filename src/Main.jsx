  ...
  return (
    ...
    >
      <AppBar position="fixed">
        <Toolbar>
          <h3>TARA Master Sheet Creator</h3>
        </Toolbar>
      </AppBar>
      <Stack direction="column" alignItems="center">
        ...
        <div>
          {interfaces.length <= 0 ? <p>Select TARA Template Path: <input type="file" name="myFile" id="myFile" onChange={changeHandler} multiple disabled={true} /></p> : <p>Select TARA Template Path: <input ref={inputRef} type="file" onChange={changeHandler} multiple /></p>}
        </div>
      </Stack>
